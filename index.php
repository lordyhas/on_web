                ...
                <div class="col">
                    ...
                    <div class="colorlib-feature colorlib-feature-sm ">
                        ...
                        <div class="colorlib-text">
                            ...
                            <p>
                                <a href="https://twitter.com/lordyhas" target="_blank"> <i
                                            class="text-secondary icon-twitter2"></i> lordyhas</a> <br/>
                                <a href="https://instagram.com/lordyhas" target="_blank"> <i
                                            class="text-secondary icon-instagram"></i> lordyhas</a> <br/>
                            </p>
                        </div>
                    </div>
    ...
    <div class="container-wrap">
        ...
        <aside id="colorlib-aside" role="complementary" class="border js-fullheight">
            <div class="text-center">
                ...
                <h1 id="colorlib-logo"><a href="/home" style="text-decoration: none;">Hassan Kajila<br/>
                        <i>@lordyhas</i> </a></h1>
            ...
            <div class="colorlib-footer">
                <p>
                    <small>Copyright &copy;
                        ...
                        Hassan Kajila. All rights reserved.
                                    ...
                                    <div class="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                                        <div class="slider-text-inner js-fullheight">
                                            <div class="desc">
                                                ...
                                                <p>
                                                    <button onclick="openWin('/about')"
                                                            style="border: 1px solid #fff; color: #fff;"
                                                            class="btn btn-learn ">View My profile<i
                                                                class="icon-briefcase3"></i></button>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="about-desc">
                                        ...
                                        <p><strong>Hi, I'm Lordy Hassan Kajila </strong>
                                            Computer scientist, Numerician, Developer and Researcher evolving in
                                            Artificial Intelligence (Machine Learning & Computer Vision),
                                            and in Data Science.<br/>
                                            What characterizes me is creativity. I put this skill to use in the
                                            development of software and multi-platform applications
                                        ...
                                        <p>
                                            ...
                                            of satisfying my customers. I like people
                    ...
                    <div class="row row-pt-md">
                        ...
                        <div class="col-md-4 text-center animate-box">
                            <div class="services color-8" style="background-color: #f2f3f7;">
                                ...
                                <div class="desc">
                                    <h3>Electrical</h3>
                                    <p>Assembly, installation and maintenance of electrical installations in
                                        buildings.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 text-center animate-box">
                            ...
                            <span class="colorlib-counter js-counter" data-from="0"
                                  data-to=<?= $coc ?> data-speed="7500" data-refresh-interval="50"></span>
                ...
                <div class="colorlib-narrow-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 animate-box" data-animate-effect="fadeInRight">
                            <div class="project" style="background-image: url(images/hoc.jpg);">
                                <div class="desc">
                                    <div class="con">
                                        <h3><a href="https://xclassroom.hassankajila.com/"
                                               target="_blanc">x-classroom</a></h3>
                        ...
                        <div class="col-md-6 animate-box" data-animate-effect="fadeInBottom">
                            <div class="project" style="background-image: url(images/anpr.jpeg);">
                                <div class="desc">
                                    <div class="con">
                                        <h3><a href="/blog/abstract?id=alpr_abstract">Computer Vision : License Plate
                                                Recognition </a></h3>
                        ...
                        <div class="col-md-6 animate-box" data-animate-effect="fadeInTop">
                            <div class="project" style="background-image: url(images/project_stats_1.jpeg);">
                                <div class="desc">
                                    <div class="con">
                                        <h3><a href="https://github.com/lordyhas/python_scientific_calculus"
                                               target="_blanc">L2CS21 </a></h3>
                    ...
                    <div class="row">
                        <div class="col-md-12 animate-box">
                            <p><a href="#" class="btn btn-primary btn-lg btn-load-more">More <i class="icon-reload"></i></a>
                            </p>
                        </div>
                    </div>
                </div>
